...
class User implements UserInterface
{
     ...
     * @Groups({"user:read", "group:item:read","group:read", "event:read", "note:read", "shoppingList:read", "shoppingListItem:read"})
     */
    private $id;
     ...
     * @Groups({"user:read", "user:write", "note:read", "event:read", "note:read", "shoppingList:read","shoppingListItem:read" })
     * @Assert\NotBlank()
     */
    private $firstName;
